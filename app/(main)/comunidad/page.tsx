...
export const metadata: Metadata = buildMetadata({
  ...
  description: 'Actividad reciente y recursos para la comunidad brasileña en Barcelona y Cataluña.',
  path: '/comunidad',
  keywords: ['comunidad brasileña Barcelona', 'brasileños en España', 'brasileños Barcelona'],
})
        ...
        <section className="bg-gradient-to-br from-[#009C3B] to-[#007a2f] rounded-3xl p-10 sm:p-14 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Link href="/empleos/publicar">
              <Button variant="outline" className="bg-transparent border-white/30 text-white hover:bg-white/10 font-semibold px-8 h-12">
                Publicar empleo
              </Button>
            </Link>
          </div>
