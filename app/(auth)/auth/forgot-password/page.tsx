  ...
  if (sent) {
    return (
      <div className="text-center py-8">
        ...
        <h2 className="text-2xl font-black text-gray-900 mb-3">Email enviado</h2>
        <p className="text-gray-500 mb-2">
          Si <strong>{getValues('email')}</strong> está registrado, recibirás un enlace para restablecer tu contraseña.
        </p>
        <p className="text-gray-400 text-sm mb-8">Revisa también tu carpeta de spam.</p>
